...
HD_PWD='E:/220210831/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VideoTimingGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VideoTimingGen.tcl
